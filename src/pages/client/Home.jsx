...
function Home() {
  const { data: sanPhams, isLoading: loading, isError: error } = useProduct();
    ...
    <div>
      ...
      <div className="container py-5">
        ...
        <div className="row">
          {!loading &&
            sanPhams.map((item) => (
              <div className="col-md-3 mb-4" key={item.maSp}>
            ...
            <div className="col-md-3 mb-4">
              ...
              <div className="d-flex justify-content-center align-items-start">
                ...
                <div className="text-start">
                  ...
                  <p className="mb-0">
                    {" "}
                    Hoàn hảo cho các dự án giáo dục thông qua việc học STEM thực
                    hành bằng tay{" "}
                  </p>{" "}
                </div>{" "}
              </div>{" "}
            ...
            <div className="col-md-3 mb-4">
              ...
              <div className="d-flex justify-content-center align-items-start">
                ...
                <div className="text-start">
                  ...
                  <p className="mb-0">
                    {" "}
                    Tất cả các vật liệu đều được lấy từ nguồn cung eco-friendly
                    để bảo vệ hành tinh{" "}
                  </p>{" "}
                </div>{" "}
              </div>{" "}
      ...
      <div className="container text-center py-5">
        ...
        <p className="text-muted mb-5">
          Khám phá các danh mục được đề xuất của chúng tôi để nhanh chóng tìm
          thấy bộ kit xây dựng ưa thích của bạn!
        </p>

    ...
    <div className="sidebar">
      ...
      <ul className="nav flex-column">
        ...
        <li className="nav-item mb-2">
          ...
          {openMenus.customer && (
            <ul className="nav flex-column ms-4 mt-2 submenu">
              <li><a href="#" className="nav-link text-white-50 small">Danh sách khách hàng</a></li>
              <li><a href="#" className="nav-link text-white-50 small">Khách hàng thân thiết</a></li>
              <li><a href="#" className="nav-link text-white-50 small">Phản hồi khách hàng</a></li>
            </ul>
          )}
        </li>
        ...
        <li className="nav-item mb-2">
          ...
          {openMenus.staff && (
            <ul className="nav flex-column ms-4 mt-2 submenu">
              <li><a href="#" className="nav-link text-white-50 small">Danh sách nhân viên</a></li>
